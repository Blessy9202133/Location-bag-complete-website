...
<style>
    body {
  background: url("knowplace_background.jpeg") no-repeat center center fixed;
...
<body>
    ...
    <?php if(isset($_SESSION['username'])) { ?>
      ...
      <center>
      <button onclick="getLocation()" style="padding:10px; cursor:pointer; font-size:20px; margin:10px; background-color: #7a1183; color: white;border: none;border-radius: 5px;">Show places near me</button>
    </center>
    </div1>
    <?php } else { ?>
